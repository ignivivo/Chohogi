### H8 · Mockup Split (minimal-frame)
Headline left, real screenshot right, the screenshot tilted 1–3° when the composition benefits. Frame can be a minimal hairline or floating no-frame; do not draw browser or device chrome.
