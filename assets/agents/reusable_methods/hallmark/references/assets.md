...
1. **Minimal frame for SaaS / web apps.** Use a real screenshot with a hairline border when it needs separation. Do not use Browserframe or hand-build browser chrome, macOS dots, or device frames.
