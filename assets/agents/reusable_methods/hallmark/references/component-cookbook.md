...
- **H8 · Mockup split minimal-frame** — Headline left, real screenshot right, optionally tilted 1–3°. Frame can be a minimal hairline or floating no-frame. [`components/h8-mockup-split-browser-framed.md`](components/h8-mockup-split-browser-framed.md)
