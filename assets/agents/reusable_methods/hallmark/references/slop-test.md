...
Use this list as a manual review before handing back an output. Record applicable findings and revisions in the Step 5 preview block; do not claim an automated all-pass result.
...
38a. Is italic display carrying a real established-brand or editorial concept, and does it remain readable at the relevant widths? If it is only an isolated emphasis word or an unmotivated AI-style flourish, revise it. Prefer weight, accent colour, or a drawn underline for ordinary emphasis. (Applies to every theme; italic is a deliberate type role, not a default.)
