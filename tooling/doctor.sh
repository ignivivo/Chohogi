...
need "$root/tooling/verify-homeostasis-policy.py"
...
need "$root/assets/agents/chohogi/trunk/state-transition.md"
need "$root/assets/agents/chohogi/trunk/authority-lattice.md"
need "$root/assets/agents/chohogi/trunk/leaf-methods.md"
need "$root/assets/agents/chohogi/trunk/meristem-capability-lifecycle.md"
need "$root/assets/agents/chohogi/trunk/vascular-bundle/xylem-context.md"
need "$root/assets/agents/chohogi/trunk/vascular-bundle/phloem-feedback.md"
...
need "$root/assets/agents/chohogi/trunk/evals/learning-fixtures.json"
...
need "$root/assets/agents/chohogi/trunk/evals/evaluation-budget-policy.md"
need "$root/assets/agents/chohogi/trunk/evals/homeostasis-admission-fixtures.json"
...
need "$root/assets/agents/skills/homeostasis/references/admission-policy.md"
...
need "$target_home/.agents/skills/homeostasis/references/admission-policy.md"
...
need "$target_home/.agents/chohogi/trunk/state-transition.md"
need "$target_home/.agents/chohogi/trunk/authority-lattice.md"
need "$target_home/.agents/chohogi/trunk/leaf-methods.md"
need "$target_home/.agents/chohogi/trunk/meristem-capability-lifecycle.md"
need "$target_home/.agents/chohogi/trunk/vascular-bundle/xylem-context.md"
need "$target_home/.agents/chohogi/trunk/vascular-bundle/phloem-feedback.md"
...
need "$target_home/.agents/chohogi/trunk/evals/learning-fixtures.json"
...
need "$target_home/.agents/chohogi/trunk/evals/evaluation-budget-policy.md"
need "$target_home/.agents/chohogi/trunk/evals/homeostasis-admission-fixtures.json"
